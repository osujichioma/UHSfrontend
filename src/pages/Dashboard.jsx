      ...
      {admin && (
        <AdminSidebar>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-4 m-2">
            ...
            />
            <Card
              cardname="Lab Technicians"
              number={labouratorists?.length}
              pic={`${laboratoristpic}`}
              linkTo={"/admin/lab_technician"}
            />
            <Card
        ...
        <ReceptionistSidebar>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-4 m-2">
            <Card
              ...
              number={patients?.length}
              pic={`${pictwo}`}
              linkTo={"/record_officer/patients"}
            />
            <Card
              cardname="Queue"
              number={Queues?.length}
              pic={`${queue}`}
              linkTo={"/record_officer/queue"}
            />
            <Card
              cardname="Appointments"
              number={appointments?.length}
              pic={`${appointmentpic}`}
              linkTo={"/record_officer/appointments"}
            />
            <Card
              cardname="Profile"
              number="@"
              pic={`${settingpic}`}
              linkTo={"/record_officer/profile"}
            />
          </div>
          <ReactCalendar />
        </ReceptionistSidebar>
