      ...
      <LoginProvider>
        <BrowserRouter>
          ...
          <Routes>
            ...
            <Route path="/admin/lab_technician" element={<Labouratorist />} />
            <Route
              path="/admin/edit_lab_technician"
            ...
            <Route path="/admin/record_officer" element={<Receptionist />} />
            <Route
              path="/admin/edit_record_officer"
            ...
            {/* ==============LABOURATORIST================== */}
            <Route
              path="/lab_technician/blood_donor"
              element={<LabouratoristBloodDonor />}
            />
            <Route
              path="/lab_technician/edit_blooddonor"
              element={<LabouratoristEditBloodDonor />}
            />
            <Route
              path="/lab_technician/dispatch_blood"
              element={<LabouratoristDispatchBlood />}
            />
            <Route
              path="/lab_technician/edit_dispatchedblood"
              element={<LabouratoristEditDispatchBlood />}
            />
            <Route
              path="/lab_technician/blood_bank"
              element={<LabouratoristBloodBank />}
            />
            <Route
              path="/lab_technician/profile"
              element={<LabouratoristProfile />}
            />
            {/* ==============RECEPTIONIST================== */}
            <Route
              path="/record_officer/patients"
              element={<ReceptionistsPatients />}
            />
            <Route
              path="/record_officer/edit_patient"
              element={<ReceptionistsEditPatient />}
            />
            <Route
              path="/record_officer/queue"
              element={<ReceptionistsQueue />}
            />
            <Route
              path="/record_officer/edit_queue"
              element={<ReceptionistsEditQueue />}
            />
            <Route
              path="/record_officer/appointments"
              element={<ReceptionistAppointments />}
            />
            <Route
              path="/record_officer/profile"
