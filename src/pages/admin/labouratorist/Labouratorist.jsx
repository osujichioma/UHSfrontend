  ...
  return (
    <AdminSidebar>
      <Tabs
              ...
              {currentPosts.map((labouratorist, i) => {
                return (
                  <Tbody key={i}>
                    ...
                    <OptionsTd>
                      <EditButton
                        editFunction={`/admin/edit_lab_technician?edit=${labouratorist._id}`}
                      >
                        Edit
                        <RiEdit2Line />
                      </EditButton>
        ...
        label2="Add Lab Technician"
        content2={
          <CreateStaff
            role="labouratorist"
            buttonName="Add Lab Technician"
            formName="ADD LAB TECHNICIAN"
