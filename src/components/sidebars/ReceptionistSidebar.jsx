...
function ReceptionistSidebar({ children }) {
  ...
  const menus = [
    ...
    { name: "Patients", link: "/record_officer/patients", icon: IoIosPeople },
    { name: "Queue", link: "/record_officer/queue", icon: MdQueue },
    {
      name: "Appointments",
      link: "/record_officer/appointments",
      icon: BiTime,
    },
    {
      name: "Profile",
      link: "/record_officer/profile",
          ...
          <div className="text-xl text-gray-900 w-full bg-gray-50">
            <div className="bg-white h-16 p-4 flex items-center justify-between gap-3">
              <h1 className="text-indigo-900 text-lg lg:text-2xl font-bold flex items-center gap-2">
                {React.createElement(GiNurseMale, { size: "20" })}RECORD OFFICER
              </h1>
