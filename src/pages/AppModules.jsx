      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 p-8">
        ...
        <div className="p-2">
          ...
          <ul className="list-disc px-4">
            ...
            <li>Manage Nurses</li>
            <li>Manage Lab Technicians</li>
            <li>Manage Accountants</li>
            <li>Manage Pharmacists</li>
            <li>Manage Record Officers</li>
        ...
        <div className="p-2">
          <h1 className="underline font-semibold">LAB TECHNICIAN</h1>
          <ul className="list-disc px-4">
            <li>Rich Dashboard</li>
            <li>Manage Blood Donor</li>
            <li>Manage Dispatch Blood</li>
        ...
        <div className="p-2">
          <h1 className="underline font-semibold">RECORD OFFICERS</h1>
          <ul className="list-disc px-4">
            <li>Rich Dashboard</li>
            <li>Manage Patients</li>
